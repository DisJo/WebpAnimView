...
//    private static ImagePipelineConfig sOkHttpImagePipelineConfig;
    ...
    public static ImagePipelineConfig getImagePipelineConfig(Context context) {
        if (sImagePipelineConfig == null) {
            ...
            configBuilder.setMemoryTrimmableRegistry(new MyMemoryTrimmableRegistry());
...
//                Integer.MAX_VALUE);                    // Max cache entry size
        ...
        MemoryCacheParams bitmapCacheParams = null;
        /**
         * fix fresco TooManyBitmapsException
         * @see com.facebook.imagepipeline.memory.BitmapCounterProvider.MAX_BITMAP_COUNT
         */
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            bitmapCacheParams = new MemoryCacheParams(MAX_MEMORY_CACHE_SIZE, 380, MAX_MEMORY_CACHE_SIZE, Integer.MAX_VALUE, Integer.MAX_VALUE);
        } else {
        ...
        final MemoryCacheParams returnbitmapCacheParams = bitmapCacheParams;

        configBuilder.setBitmapMemoryCacheParamsSupplier(
                        new Supplier<MemoryCacheParams>() {
                            public MemoryCacheParams get() {
                                return returnbitmapCacheParams;
                            }
